            ...
            <div class="col-md-9">
                <div class="card mt-5">
                    <div class="card-header">
                        <h3 class="card-title float-left"><strong>Add New Sublet House</strong></h3>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('landlord.sublet-house.store') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_for_married" class="form-control" id="is_for_male">
                                    ...
                                    <option value="1" {{ old('is_for_married') == '1' ? 'selected' : '' }} >Married
                                    </option>
                                    <option value="0" {{ old('is_for_married') == '0' ? 'selected' : '' }} >Unmarried
                                    </option>
                                </select>
                            </div>
