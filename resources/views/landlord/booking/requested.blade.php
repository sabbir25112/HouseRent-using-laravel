                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-info btn-sm" type="button"
                                                        onclick="accept({{ $book->id }})">
                                                    Accept
                                                </button>

                                                <form id="accept-form-{{ $book->id }}"
                                                      action="{{ route('landlord.request.accept', $book->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form id="reject-form-{{ $book->id }}"
                                                      action="{{ route('landlord.request.reject', $book->id) }}"
                                                      method="POST" style="display: none;">
                                                    @csrf
                                                </form>
