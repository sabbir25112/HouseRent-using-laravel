            ...
            <div class="col-md-9">
                <div class="card mt-5">
                    <div class="card-header">
                        <h3 class="card-title float-left"><strong>Edit Bachelor House</strong></h3>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('landlord.bachelor-house.update', $house->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <select name="area_id" class="form-control" id="area_id">
                                    ...
                                    @foreach ($areas as $area)
                                        <option
                                            value="{{ $area->id }}" {{ $house->area_id == $area->id ? 'selected' : '' }} >{{ $area->name }}</option>
                                    @endforeach
                                </select>
                            </div>
...
{{--                            </div>--}}
                            ...
                            <div class="form-group">
                                ...
                                <select name="house_for" class="form-control" id="house_for">
                                    ...
                                    <option value="jobholder" {{ $house->house_for == 'jobholder' ? 'selected' : '' }} >Job Holder</option>
                                    <option value="student" {{ $house->house_for == 'student' ? 'selected' : '' }} >Student</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_for_male" class="form-control" id="is_for_male">
                                    ...
                                    <option value="1" {{ $house->is_for_male == '1' ? 'selected' : '' }} >Male</option>
                                    <option value="0" {{ $house->is_for_male == '0' ? 'selected' : '' }} >Female</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="has_ac" class="form-control" id="has_ac">
                                    ...
                                    <option value="1" {{ $house->has_ac == '1' ? 'selected' : '' }} >Yes</option>
                                    <option value="0" {{ $house->has_ac == '0' ? 'selected' : '' }} >No</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="rent_per_room" id="rent_per_room" name="rent_per_room"
                                       value="{{ old('rent_per_room') ?? $house->rent_per_room }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="rent_per_seat" id="rent_per_seat" name="rent_per_seat"
                                       value="{{ old('rent_per_seat') ?? $house->rent_per_seat }}">
                            </div>
