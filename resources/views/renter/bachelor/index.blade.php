               ...
               @include('partial.successMessage')
                ...
                <div class="card my-5 mx-4">
                    <div class="card-header">
                      <h3 class="card-title float-left"><strong>All Available Bachelor Houses ({{ $housecount }})</strong></h3>
                    ...
                    <div class="table-responsive">
                      <table id="dataTableId" class="table table-bordered table-striped table-background">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('renter.bachelor-houses.details', $house->id) }}"  class="btn btn-success m-2">Details</a>
