                ...
                <div class="card mt-5">
                    <div class="card-header">
                      <div class="d-flex justify-content-between">
                          <div>
                              <h3><strong>Sublet House Details</strong></h3>
                          </div>
                          <div>
                            ...
                            <form id="booking-form-{{ $house->id }}" action="{{ route('sublet-booking', $house->id) }}" method="POST" style="display: none;">
                                @csrf

                            </form>
                            @endif
                              <a class="btn btn-danger" href="{{ route('renter.allSubletHouses') }}"> Back</a>
                          </div>
                      </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $house->is_for_married ? 'Married' : 'Unmarried' }}</td>
                                </tr>

                                <tr>
                                    <th>Gender Preference</th>
                                    <td>{{ $house->is_for_male ? 'Male' : 'Female' }}</td>
                                </tr>
