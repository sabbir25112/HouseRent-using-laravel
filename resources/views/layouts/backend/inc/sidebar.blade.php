        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if (Request::is('landlord*'))
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('landlord.sublet-house.index') }}"
                           class="nav-link {{ Request::is('landlord/sublet-house*') ? 'active' : '' }}">
                            <i class="fa fa-home" aria-hidden="true"></i>
                            <p class="pl-2">
                                Sublet House
                            </p>
                ...
                @if (Request::is('renter*'))
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('renter.allSubletHouses') }}"
                           class="nav-link {{ Request::is('renter/sublet-house*') ? 'active' : '' }}">
                            <i class="fa fa-home" aria-hidden="true"></i>
                            <p class="pl-2">
                                Sublet House
                            </p>
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('renter.allBachelorHouses') }}"
                           class="nav-link {{ Request::is('renter/bachelor-house*') ? 'active' : '' }}">
                            <i class="fa fa-home" aria-hidden="true"></i>
                            <p class="pl-2">
                                Bachelor House
                            </p>
